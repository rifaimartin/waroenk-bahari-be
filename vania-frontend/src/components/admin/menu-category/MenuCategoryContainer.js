                        ...
                        this.props.menuCategories.map((element, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button type="button" onClick={() => { this.handleEditData(element.idMenuCategory) }} data-toggle="modal" data-target="#modalForm" data-backdrop="static" data-keyboard="false" className="btn btn-primary ">
                                            Edit
                                        </button>
                                        &nbsp; | &nbsp;
                                        <button type="button" 
                                                onClick={() => { this.handleDeleteData(element.idMenuCategory)}}
